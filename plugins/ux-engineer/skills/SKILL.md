...
dependencies:
  synarc-core: ">=5.0.0"
title: UX Engineer â€” User Experience Research & Design Systems
description: Comprehensive UX engineering â€” user research, interaction design, information architecture, usability testing, journey mapping, wireframing, prototyping, WCAG accessibility, UX metrics, conversion optimization, cognitive UX. Inherits synarc core.
version: 1.0.0
