...
dependencies:
  synarc-core: ">=5.0.0"
title: Project Scales â€” Detection, Adaptation & Behavioral Tuning
description: Adapts cognition layer depth, brain output requirements, injection levels, checkpoint frequency, and agent behavior to six project sizes â€” from NANO (single script) to ENTERPRISE (multi-repo regulated platform). Inherits synarc core.
version: 1.0.0
