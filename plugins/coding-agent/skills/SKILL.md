...
dependencies:
  synarc-core: ">=5.0.0"
title: Coding Agent â€” Autonomous Code Generation & Execution
description: Execution model for autonomous coding agents â€” per-tool-call classification, scope enforcement, risk aggregation, checkpoint protocol, multi-file coordination, error recovery, and safe file operations. Inherits synarc core.
version: 2.0.0
