...
dependencies:
  synarc-core: ">=5.0.0"
title: Testing Strategy â€” Risk-Based Testing & Coverage
description: Risk-based testing strategy â€” test pyramid by change risk, test type selection guide, test double strategy, per-WorkType test requirements, test data management, flaky test remediation, contract testing, CI/CD test execution, and coverage quality. Inherits synarc core.
version: 1.0.0
